...
# moon_csv='/Users/ssa195/Downloads/dt8122-2022-main/datasets/two_moons.csv'
# blob_csv='/Users/ssa195/Downloads/dt8122-2022-main/datasets/two_blobs.csv'
# boom_csv='/Users/ssa195/Downloads/dt8122-2022-main/datasets/boomerang.csv'
# train1,test1=get_train_test(moon_csv)
# train1.to_csv('two_moons_train.csv')
# test1.to_csv('two_moons_test.csv')
# train2,test2=get_train_test(blob_csv)
# train2.to_csv('two_blobs_train.csv')
# test2.to_csv('two_blobs_test.csv')
# train3,test3=get_train_test(boom_csv)
# train3.to_csv('boomerang_train.csv')
# test3.to_csv('boomerang_test.csv')

# moons_df=pd.read_csv('/Users/ssa195/Downloads/dt8122-2022-main/datasets/two_moons.csv')
